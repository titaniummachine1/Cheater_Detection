...
[![ImMenu](https://img.shields.io/badge/Download-ImMenu-blue?style=for-the-badge&logo=github)](https://github.com/lnx00/Lmaobox-ImMenu/blob/main/src/ImMenu.lua)
*Copy `ImMenu.lua` to your `%localappdata%/lua` folder.*
